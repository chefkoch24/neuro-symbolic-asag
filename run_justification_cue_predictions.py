...
config = Config(
    ...
    #checkpoint_path='logs/span_prediction_distilbert-base-multilingual-cased/version_0/checkpoints/checkpoint-epoch=03-val_loss=1.47.ckpt',
    #checkpoint_path='logs/span_prediction_microsoft_mdeberta-v3-base/version_0/checkpoints/checkpoint-epoch=03-val_loss=1.41.ckpt',
    #checkpoint_path='logs/token_classification_distilbert-base-multilingual-cased_True/version_0/checkpoints/checkpoint-epoch=02-val_loss=0.42.ckpt',
    ...
    #checkpoint_path='logs/token_classification_microsoft_mdeberta-v3-base_False/version_0/checkpoints/checkpoint-epoch=04-val_loss=0.43.ckpt',
