...
for task in ['span_prediction', 'token_classification']:
    if task == 'token_classification':
        ckpt = 'logs/token_classification_microsoft_mdeberta-v3-base_True/version_0/checkpoints/checkpoint-epoch=03-val_loss=0.37.ckpt'
    else:
        ckpt = 'logs/span_prediction_microsoft_mdeberta-v3-base/version_0/checkpoints/checkpoint-epoch=02-val_loss=1.26.ckpt'
